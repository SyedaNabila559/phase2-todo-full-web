      ...
      <div className="w-full max-w-md animate-welcome z-10">
        <div className="glass-premium rounded-[2.5rem] p-8 md:p-10 border border-white/20 relative z-10">
          <div className="flex flex-col items-center text-center mb-10">
            <div className="w-16 h-16 rounded-2xl bg-primary flex items-center justify-center text-pink shadow-xl shadow-primary/30 mb-6 animate-float">
              <CheckCircle2 className="w-10 h-10" />
            </div>
            <h2 className="h2 mb-2 text-pink-400">Welcome Back</h2>
            <p className="body text-base opacity-70 text-pink-300">Experience the next level of productivity.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            >
              Sign In
              {!loading && <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform group-hover:text-pink-500" />}
            </Button>
          </form>
