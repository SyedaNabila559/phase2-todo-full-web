          ...
          <div className="lg:col-span-3 glass-premium p-10 rounded-[3rem] relative overflow-hidden group border-white/10">
            ...
            <div className="relative z-10">
              <div className="flex justify-between items-end mb-8">
                <div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="px-4 py-2 bg-emerald-500/10 text-red-500 rounded-full text-xs font-black border border-emerald-500/20">
                      +12% INCREMENTAL
                    </div>
                  </div>
                </div>
              ...
              <div className="w-full h-3 bg-muted/30 rounded-full overflow-hidden mb-6 border border-ui-border/10 p-0.5">
                <div
                  className="h-full bg-gradient-to-r from-primary via-pink-500 to-indigo-500 rounded-full transition-all duration-1000 ease-out shadow-[0_0_15px_rgba(var(--primary),0.5)]"
