  ...
  return (
    <header className="min-h-[calc(100vh-80px)] relative flex items-center justify-center text-center overflow-hidden">
      ...
      >
        ...
        <h1 className="text-6xl md:text-8xl font-black tracking-tighter leading-[0.9] text-pink-500 mb-6">
          Transform Your Tasks with the
          <br />
          <span className="text-foreground/60 text-pink-300">Ultimate Todo Experience!</span>
        </h1>

        <p className="text-xl md:text-2xl opacity-80 body max-w-3xl mx-auto mb-10">
          Where Productivity Meets Elegance: Glass, Motion, and Interactions That Elevate Your Planning
        </p>
        ...
        <div className="flex items-center justify-center gap-4">
          ...
          <Link href="/dashboard">
            <Button variant="ghost" size="lg" className="h-16 px-8 rounded-2xl hover:pink-200">
